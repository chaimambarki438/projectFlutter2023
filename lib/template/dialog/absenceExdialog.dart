...
class AbsenceExDialog extends StatefulWidget {
  ...
  @override
  State<AbsenceExDialog> createState() => AbsenceDialogState();
}

class AbsenceDialogState extends State<AbsenceExDialog> {
