...
class AbsenceScreenEx extends StatefulWidget {
  @override
  AbsenceScreenState createState() => AbsenceScreenState();
}

class AbsenceScreenState extends State<AbsenceScreenEx> {
  List<Classe> classes = [];
          ...
          ElevatedButton(
            onPressed: () async {
              if (selectedClass != null &&
                  ...
                  selectedDate != null) {
                await getAbsenceByMatiereAndDate(
